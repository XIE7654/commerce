CREATE TABLE IF NOT EXISTS amazon_api_request_log (
    ...
    shop_id BIGINT NULL COMMENT 'Amazon 店铺编号',
    country_code VARCHAR(8) NULL COMMENT '站点国家代码',
    marketplace_ids JSON NULL COMMENT '请求的 Marketplace ID 列表',
    ...
    error_code VARCHAR(128) NULL COMMENT 'Amazon 或应用错误码',
    error_message VARCHAR(1000) NULL COMMENT '脱敏后的错误信息',
    amazon_request_id VARCHAR(128) NULL COMMENT 'Amazon 请求编号，例如 x-amzn-RequestId',
    rate_limit VARCHAR(64) NULL COMMENT 'Amazon 返回的速率限制',
    ...
    PRIMARY KEY (id),
    UNIQUE KEY uk_amazon_api_request_log_tenant_request (tenant_id, request_id),
    KEY idx_amazon_api_request_log_tenant_shop_time (tenant_id, shop_id, requested_at),
