...
public class AmazonOrdersController {
    ...
    public CommonResult<AmazonApiResponse<Map<String, Object>>> getOrders(@Valid @RequestBody AmazonOrdersListReqVO request) {
    ...
    @PreAuthorize("@ss.hasPermission('amazon:orders:query')")
    public CommonResult<AmazonApiResponse<Map<String, Object>>> getOrder(@Valid @RequestBody AmazonOrderGetReqVO request) {
    ...
    @PreAuthorize("@ss.hasPermission('amazon:orders:query')")
    public CommonResult<AmazonApiResponse<Map<String, Object>>> getOrderItems(@Valid @RequestBody AmazonOrderItemsReqVO request) {
    ...
    @PreAuthorize("@ss.hasPermission('amazon:orders:query')")
    public CommonResult<AmazonApiResponse<Map<String, Object>>> getOrderItemsBuyerInfo(@Valid @RequestBody AmazonOrderItemsReqVO request) {
    ...
    @PreAuthorize("@ss.hasPermission('amazon:orders:query')")
    public CommonResult<AmazonApiResponse<Map<String, Object>>> getOrderBuyerInfo(@Valid @RequestBody AmazonOrderGetReqVO request) {
    ...
    @PreAuthorize("@ss.hasPermission('amazon:orders:query')")
    public CommonResult<AmazonApiResponse<Map<String, Object>>> getOrderAddress(@Valid @RequestBody AmazonOrderGetReqVO request) {
    ...
    @PreAuthorize("@ss.hasPermission('amazon:orders:query')")
    public CommonResult<AmazonApiResponse<Map<String, Object>>> getOrderRegulatedInfo(@Valid @RequestBody AmazonOrderGetReqVO request) {
    ...
    public CommonResult<AmazonApiResponse<Map<String, Object>>> updateShipmentStatus(@Valid @RequestBody AmazonOrderShipmentReqVO request) {
    ...
    @PreAuthorize("@ss.hasPermission('amazon:orders:update')")
    public CommonResult<AmazonApiResponse<Map<String, Object>>> confirmShipment(@Valid @RequestBody AmazonOrderShipmentConfirmationReqVO request) {
    ...
    @PreAuthorize("@ss.hasPermission('amazon:orders:update')")
    public CommonResult<AmazonApiResponse<Map<String, Object>>> updateOrderRegulatedInfo(
    ...
    @PreAuthorize("@ss.hasPermission('amazon:orders:query')")
    public CommonResult<AmazonApiResponse<Map<String, Object>>> getOrders2026(@Valid @RequestBody AmazonOrders2026ListReqVO request) {
    ...
    @PreAuthorize("@ss.hasPermission('amazon:orders:query')")
    public CommonResult<AmazonApiResponse<Map<String, Object>>> getOrder2026(@Valid @RequestBody AmazonOrder2026GetReqVO request) {
