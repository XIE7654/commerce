...
public interface AmazonShopMarketplaceParticipationMapper extends BaseMapperX<AmazonShopMarketplaceParticipationDO> {
     ...
     */
    default List<AmazonShopMarketplaceParticipationDO> selectParticipatingByShopId(Long shopId) {
        return selectList(AmazonShopMarketplaceParticipationDO::getShopId, shopId,
                AmazonShopMarketplaceParticipationDO::getIsParticipating, true);
    }
