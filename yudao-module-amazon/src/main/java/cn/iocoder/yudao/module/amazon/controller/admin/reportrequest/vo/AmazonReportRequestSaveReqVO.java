...
@Schema(description = "管理后台 - Amazon 报表请求及异步处理任务新增/修改 Request VO")
@Data
public class AmazonReportRequestSaveReqVO {
    ...
    @NotEmpty(message = "Amazon 报表类型，例如 GET_MERCHANT_LISTINGS_ALL_DATA不能为空")
    ...
    @NotNull(message = "乐观锁版本，防止多个任务执行器重复处理不能为空")
