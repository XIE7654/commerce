...
public interface ErrorCodeConstants {
    ...
    ErrorCode SHIPPING_COMPANY_NOT_EXISTS = new ErrorCode(1_300_004_000, "Temu 区域承运商目录不存在");

    ErrorCode ORDER_NOT_EXISTS = new ErrorCode(1_300_005_000, "Temu 订单不存在");

    ErrorCode ORDER_SHIPPING_INFO_NOT_EXISTS = new ErrorCode(1_300_006_000, "Temu 父订单收货信息不存在");
}
