...
@Schema(description = "管理后台 - Temu 父订单收货信息 Response VO")
@Data
@ExcelIgnoreUnannotated
public class TemuOrderShippingInfoRespVO {
